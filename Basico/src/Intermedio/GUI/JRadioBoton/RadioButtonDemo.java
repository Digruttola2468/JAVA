package Intermedio.GUI.JRadioBoton;
import java.awt.*;
...
public class RadioButtonDemo extends JPanel
    ...
    public RadioButtonDemo() {
        ...
        birdButton.setActionCommand(birdString);    //Enviar String del comando
        birdButton.setSelected(true);           //Empezar seleccionado

        JRadioButton catButton = new JRadioButton(catString);
        catButton.setMnemonic(KeyEvent.VK_C);        //ALT + C
        catButton.setActionCommand(catString);      //Enviar String del comando
