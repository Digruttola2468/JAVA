package Intermedio.GUI.JCheckCaja;
import java.awt.*;
...
public class CheckBoxDemo extends JPanel
    ...
    public CheckBoxDemo() {
        //JPanel tendra el Layout de BorderLayout
        super(new BorderLayout());

        //Create the check boxes.
        chinButton = new JCheckBox("Chin");
        chinButton.setMnemonic(KeyEvent.VK_C);  //ALT + C
        chinButton.setSelected(true);

        glassesButton = new JCheckBox("Glasses");
        glassesButton.setMnemonic(KeyEvent.VK_G); //ALT + G
        glassesButton.setSelected(true);

        hairButton = new JCheckBox("Hair");
        hairButton.setMnemonic(KeyEvent.VK_H);  //ALT + H
        hairButton.setSelected(true);

        teethButton = new JCheckBox("Teeth");
        teethButton.setMnemonic(KeyEvent.VK_T); //ALT + T
        ...
        //Ubicacion de los CheckBoxs y la imagen
        add(checkPanel, BorderLayout.LINE_START);
        add(pictureLabel, BorderLayout.CENTER);

        //Es como un margin dentro del Panel
    ...
    public void itemStateChanged(ItemEvent e) {
        int index = 0;
        char c = '-';
        //Obtenemos el item seleccionado obteniendo el objeto ensi
    ...
    protected void updatePicture() {
        ...
        pictureLabel.setToolTipText(choices.toString());    //Mantener el mause en la imagen aparece un texto
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = CheckBoxDemo.class.getResource(path); //Image Locate
        if (imgURL != null) {
